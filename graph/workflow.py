    ...
    def _format_output(self, state: TradingState) -> Dict[str, Any]:
        ...
        return {
            ...
            "technical": {
                ...
                "stoch_k": technical.stoch_k if technical else 50.0,
                "stoch_d": technical.stoch_d if technical else 50.0,
                "stoch_signal": technical.stoch_signal if technical else "NEUTRAL",
                "adx": technical.adx if technical else 0.0,
                "adx_signal": technical.adx_signal if technical else "NO_TREND",
                "plus_di": technical.plus_di if technical else 0.0,
                "minus_di": technical.minus_di if technical else 0.0,
                "atr": technical.atr if technical else 0.0,
                "atr_percent": technical.atr_percent if technical else 0.0,
                "support_level": technical.support_level if technical else 0.0,
                "resistance_level": technical.resistance_level if technical else 0.0,
                "price_to_support": technical.price_to_support if technical else 0.0,
                "price_to_resistance": technical.price_to_resistance if technical else 0.0,
                "ema_12": technical.ema_12 if technical else 0.0,
                "ema_26": technical.ema_26 if technical else 0.0,
            ...
            "fundamental": {
                ...
                "earnings_growth": fundamental.earnings_growth if fundamental else None,
                ...
                "ev_to_ebitda": fundamental.ev_to_ebitda if fundamental else None,
                "price_to_sales": fundamental.price_to_sales if fundamental else None,
                ...
                "payout_ratio": fundamental.payout_ratio if fundamental else None,
                "current_ratio": fundamental.current_ratio if fundamental else None,
                "asset_turnover": fundamental.asset_turnover if fundamental else None,
            ...
            "risk": {
                ...
                "volatility_value": risk.volatility_value if risk else 0.0,
                "volume": risk.volume if risk else 0,
                "passes_volatility_check": risk.passes_volatility_check if risk else False,
                "passes_liquidity_check": risk.passes_liquidity_check if risk else False,
                "passes_confidence_check": risk.passes_confidence_check if risk else False,
                "passes_conflict_check": risk.passes_conflict_check if risk else False,
                "conflicting_signals": risk.conflicting_signals if risk else [],
                # NEW: Advanced risk metrics
                "beta": risk.beta if risk else None,
                "sharpe_ratio": risk.sharpe_ratio if risk else None,
                "max_drawdown": risk.max_drawdown if risk else None,
                "value_at_risk": risk.value_at_risk if risk else None,
                "sortino_ratio": risk.sortino_ratio if risk else None,
                "position_risk": risk.position_risk if risk else "MEDIUM",
                "suggested_position_size": risk.suggested_position_size if risk else None,
